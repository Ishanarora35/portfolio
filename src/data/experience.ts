...
export const experience: ExperienceGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "Software Lead & Programming Team Member",
        org: "Engineering Club",
        period: "2025",
        points: [
          "Served as software lead on a low-cost myoelectric bionic prosthetic hand, building the signal-processing and motor-control code that turns forearm muscle (EMG) signals into finger movement.",
          "Implemented an exponential moving average (EMA) filter and threshold-based logic to stabilize noisy sensor data and prevent accidental actuation.",
          "Competed in the international MATE ROV underwater-robotics competition, personally building the ROV-to-operator communications system using MQTT.",
        ],
        tags: ["Software Lead", "Robotics", "EMG", "MQTT"],
      },
    ],
  },
  {
