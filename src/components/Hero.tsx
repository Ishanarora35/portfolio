    ...
    <div className="relative overflow-hidden border-b border-line/70">
      ...
      <Section className="relative pt-20 pb-20 sm:pt-28 sm:pb-28">
        ...
        <motion.h1
          ...
          className="max-w-4xl text-5xl font-bold leading-[1.02] tracking-tightest text-ink sm:text-7xl"
        >
          Hi, I&apos;m Ishan Arora
        </motion.h1>
        ...
        <motion.p
          ...
          className="mt-6 max-w-2xl text-lg font-medium text-ink sm:text-xl"
        >
          Computer Science student, software engineer, and problem solver.
        </motion.p>
